              ...
              {activeTab === 'home' && (
                <div className="h-full flex flex-col gap-3 p-3 pb-2">
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    <div className="flex items-center gap-1 rounded-lg p-0.5" style={{ backgroundColor: 'var(--color-premium-surface)', border: '1px solid var(--color-premium-border)' }}>
                      <button
                        ...
                        style={{ backgroundColor: homeViewMode === 'grid' ? 'var(--color-premium-gold-400)' : 'transparent', color: homeViewMode === 'grid' ? 'var(--color-premium-text-inverse)' : 'var(--color-premium-text-secondary)' }}
                      >
                      ...
                      <button
                        ...
                        className="flex items-center gap-1 px-2.5 py-1 rounded-md text-[10px] font-bold cursor-pointer"
                        style={{ backgroundColor: homeViewMode === 'map' ? 'var(--color-premium-gold-400)' : 'transparent', color: homeViewMode === 'map' ? 'var(--color-premium-text-inverse)' : 'var(--color-premium-text-secondary)' }}
                      >
                        <MapIcon size={11} /> Map
                      </button>
                    </div>
