  ...
  return (
    <div className="app-shell-height md:min-h-screen w-full bg-gradient-to-br from-[#faf6f0] via-[#f4e7d3] to-[#e6d3b4] text-slate-800 flex flex-col items-center justify-start md:justify-center p-0 md:p-6 select-none overflow-hidden relative font-sans">
      ...
      <div className="app-shell-height relative w-full md:h-[880px] md:max-w-[420px] bg-[var(--color-ink-900)] md:rounded-[42px] md:border-[10px] md:border-[#523318] md:shadow-[0_24px_64px_rgba(82,51,24,0.45)] flex flex-col overflow-hidden">
        ...
        {/* Header pool claim overlay — same proven positioning pattern as
            the Milestone celebration (absolute, top-1/3, centered, z-50),
            not the toast-style pattern used for the unlock notice above.
          ...
          {poolClaimUI && (
            <>
              <motion.div
                ...
                onClick={() => poolClaimUI.state === 'collected' && setPoolClaimUI(null)}
              />
              <motion.div
                ...
                className="absolute inset-x-8 top-1/3 z-50 p-6 rounded-3xl text-center flex flex-col items-center overflow-visible glossy-3d"
              >
                ...
                {poolClaimUI.state === 'collected' ? (
                  <>
                    ...
                    <div className="text-[15px] font-bold flex items-center justify-center gap-1.5" style={{ color: 'var(--color-premium-green-500)' }}>
                      + {formatCash(poolClaimUI.amount)} ✓
                    </div>
                    <div className="font-bold text-[20px] mt-0.5" style={{ color: 'var(--color-premium-green-500)' }}>Collected!</div>
                    <button
                      onClick={handleHeaderDoubleClaim}
                      className="w-full mt-4 py-2.5 rounded-xl font-bold text-[12px] flex items-center justify-center gap-1.5 cursor-pointer"
