...
export interface PlayerStats {
  ...
  /** Title of the most recently unlocked achievement, or null if none
   *  yet — powers the Home screen's Recent Achievement callout. Updated
   *  by the same global achievement-detection effect already built for
   *  the Milestone celebration; no separate tracking needed. */
