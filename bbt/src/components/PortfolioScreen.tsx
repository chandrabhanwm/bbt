      ...
      >
        ...
        <div className="rounded-xl p-2.5 mt-2.5" style={{ backgroundColor: 'var(--color-premium-elevated)' }}>
          <AnimatePresence mode="wait">
            ...
            {claimState === 'cooldown' && (
              <motion.div key="cooldown" initial={{ opacity: 0, scale: 0.95 }} animate={{ opacity: 1, scale: 1 }} exit={{ opacity: 0 }} className="text-center py-2.5">
                <div className="font-bold text-[14px]" style={{ color: 'var(--color-premium-text)' }}>
                  ⏱️ Please wait {cooldownSecondsRemaining}s
                </div>
