  ...
  return (
    ...
    >
      <div className="flex flex-nowrap items-stretch gap-1.5">
        ...
        {/* ============ Rank pill ============ */}
        <div
          className="glossy-3d flex-shrink-0 flex items-center gap-1 rounded-xl px-1.5 py-1"
        >
          <Trophy size={16} color={GOLD} className="flex-shrink-0" />
          <div className="flex flex-col leading-none">
            <span className="text-[10px] font-bold text-white whitespace-nowrap">#{stats.rank.toLocaleString('en-IN')}</span>
            <span className="text-[6.5px] font-bold tracking-wide mt-0.5" style={{ color: TEXT_SECONDARY }}>RANK</span>
          </div>
        </div>
        ...
        <button
          ...
          className="flex-shrink-0 relative w-10 h-10 rounded-full flex items-center justify-center cursor-pointer before:content-[''] before:absolute before:-inset-1"
