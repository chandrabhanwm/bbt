    ...
    >
      <div className="flex flex-nowrap items-stretch gap-1.5">
        ...
        {/* ============ Pool pill — takes the Rank pill's old spot, now
             ...
             from Home, City, Ranks, and Portfolio alike. ============ */}
        <motion.button
          whileTap={{ scale: 0.95 }}
          onClick={onClaimPool}
          className="glossy-3d flex-shrink-0 flex flex-col items-center justify-center rounded-xl px-2 py-1.5 cursor-pointer"
        >
