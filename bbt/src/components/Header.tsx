  ...
  return (
    ...
    >
      <div className="flex items-stretch gap-2">
            ...
            {editingName ? (
              ...
              <div onClick={() => { playClick(); setEditingName(true); }} className="cursor-pointer">
                <div className="flex items-center gap-1">
                  <span className="text-[12px] font-bold text-white uppercase tracking-wide whitespace-nowrap">
                    {playerName}
                  </span>
        ...
        >
          <span className="text-[8px] font-bold tracking-wider whitespace-nowrap" style={{ color: GOLD }}>CASH BALANCE</span>
