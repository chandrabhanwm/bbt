        ...
        >
          ...
          {showProfitTapHint && (
            <motion.span
              ...
              style={{ top: '55%', left: '50%', filter: 'drop-shadow(0 2px 3px rgba(0,0,0,0.4))' }}
              initial={{ x: '-50%', y: '-50%' }}
              animate={{ y: ['-50%', '-30%', '-50%'], opacity: [0, 1, 1, 0] }}
              transition={{ duration: 1.4, repeat: Infinity, repeatDelay: 1.2, ease: 'easeInOut', times: [0, 0.35, 0.75, 1] }}
            >
              👆
            </motion.span>
          )}
