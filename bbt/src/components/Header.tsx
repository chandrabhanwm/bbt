...
export const Header: React.FC<HeaderProps> = ({
  ...
  return (
    <header className="sticky top-0 z-40 w-full px-3 pt-3 pb-2.5 bg-gradient-to-b from-[var(--color-parchment-50)] to-[var(--color-parchment-100)] border-b-[3px] border-[var(--color-ink-900)] select-none">
      ...
      <div className="flex items-center gap-2">
        ...
        <div className="flex-1 min-w-0 flex items-center justify-center gap-1.5 bg-white rounded-2xl border-[2.5px] border-[var(--color-ink-900)] px-3 py-1.5 shadow-[0_3px_0_var(--color-ink-900)]">
          ...
          <motion.span
            className="font-display font-bold text-[17px] tracking-tight truncate text-toy-sm"
