...
export const BusinessGridCard: React.FC<BusinessGridCardProps> = ({ business, index, imageUrl, onSelect }) => {
  ...
  return (
    ...
    >
      ...
      <div className="relative w-full h-[88px] rounded-t-[14px] overflow-hidden flex-shrink-0">
        {imageUrl ? (
      ...
      {/* Content region — flex-shrink-0 so this block, and everything in
          ...
          illegible text rather than a clean line break. */}
      <div className="px-2 py-1.5 flex flex-col gap-1 flex-shrink-0">
...
export const BusinessGridCardComingSoon: React.FC<{ name: string }> = ({ name }) => {
  return (
    ...
    >
      <div className="relative w-full h-[88px] rounded-t-[14px] overflow-hidden flex-shrink-0 flex items-center justify-center" style={{ backgroundColor: 'var(--color-premium-elevated)' }}>
