...
export const LeaderboardTab: React.FC<LeaderboardTabProps> = ({
  ...
  return (
    <div id="leaderboard-tab" className="p-4 space-y-4 pb-28 select-none">
      ...
      <div className="relative overflow-hidden rounded-3xl court-card p-5 text-center">
        ...
        <div className="mt-4 inline-flex items-center gap-2 px-3 py-1 bg-white border border-[var(--color-court-border)] rounded-full">
      ...
      <div className="space-y-2 court-card rounded-3xl p-2.5">
      ...
      <div className="p-3 bg-white border border-[var(--color-court-border)] rounded-2xl flex gap-2.5 items-center">
