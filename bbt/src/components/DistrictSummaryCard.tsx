...
export const DistrictSummaryCard: React.FC<DistrictSummaryCardProps> = React.memo(({
  ...
  return (
    <div className="relative rounded-2xl overflow-hidden" style={{ backgroundColor: 'var(--color-premium-surface)', border: '1.5px solid var(--color-premium-border-strong)' }}>
      ...
      <div className="relative h-[104px]">
        ...
        <div className="absolute inset-x-0 top-0 flex items-start justify-between p-3">
          <div className="flex items-center gap-1.5">
            <Flag size={14} color="var(--color-premium-text)" />
          </div>
      ...
      <div className="px-3 py-3">
        <div className="w-full h-[6px] rounded-full overflow-hidden" style={{ backgroundColor: 'var(--color-premium-track)' }}>
          <motion.div
