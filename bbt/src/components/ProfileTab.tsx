...
export const ProfileTab: React.FC<ProfileTabProps> = ({
  ...
  return (
    <div id="profile-tab" className="p-4 space-y-4 pb-28 select-none">
      ...
      <div className="relative overflow-hidden rounded-3xl toy-card p-5 flex items-center gap-4">
        ...
        <div>
          ...
          <div className="mt-2.5 flex items-center gap-1.5 bg-white px-2.5 py-1 rounded-lg border border-[var(--color-ink-700)/25]">
      ...
      <div className="grid grid-cols-2 gap-3">
        ...
        {/* Stat 1 */}
        <div className="toy-card p-3 rounded-2xl flex flex-col justify-center">
        ...
        {achievements.map((ach) => (
          <div
            ...
            className={`relative rounded-2xl p-3 border transition-all flex items-center gap-3.5 ${
              ach.unlocked
                ? 'toy-card'
                : 'bg-white/50 border-[var(--color-ink-700)/25]/60 opacity-60 shadow-2xs'
            }`}
          >
            {/* Medal Icon Badge */}
