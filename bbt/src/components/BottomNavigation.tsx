...
export const BottomNavigation: React.FC<BottomNavigationProps> = ({
  ...
  return (
    ...
    >
      <div className="rounded-2xl py-2 px-2 flex justify-between items-center relative" style={{ backgroundColor: 'var(--color-premium-surface)', border: '1.5px solid var(--color-premium-border)' }}>
