  ...
  return (
    <div id="city-tab" className="p-4 space-y-4 pb-28 select-none">
      ...
      <div className="space-y-4 relative">
        ...
        <div className="absolute left-9 top-8 bottom-8 w-[3px] bg-[var(--color-court-border)] pointer-events-none"></div>
        ...
        {areas.map((area, idx) => {
          ...
          const lockStateColor = isUnlocked
            ...
            : 'border-[var(--color-court-border)] bg-white/60 backdrop-blur-md opacity-70';
