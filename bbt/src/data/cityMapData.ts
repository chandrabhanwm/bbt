...
const districts: District[] = [
  { id: 'railway_station', name: 'Railway Station', icon: 'train', emoji: '🚂', x: 220, y: 90, unlocked: false, completed: false, unlockRequirement: { type: 'net_worth', value: 25000000, label: '₹2,50,00,000 Net Worth' } },
  { id: 'plastic_complex', name: 'Plastic Complex', icon: 'factory', emoji: '🏭', x: 620, y: 90, unlocked: false, completed: false, unlockRequirement: { type: 'net_worth', value: 30000000, label: '₹3,00,00,000 Net Worth' } },
  { id: 'purani_basti', name: 'Purani Basti', icon: 'building', emoji: '🚧', x: 220, y: 270, unlocked: false, completed: false, unlockRequirement: { type: 'district_completed', districtId: 'bus_stand', label: 'Complete Bus Stand' } },
  { id: 'district_hospital', name: 'District Hospital', icon: 'hospital', emoji: '🏥', x: 560, y: 270, unlocked: false, completed: false, unlockRequirement: { type: 'net_worth', value: 15000000, label: '₹1,50,00,000 Net Worth' } },
  { id: 'bus_stand', name: 'Bus Stand', icon: 'bus', emoji: '🚌', x: 390, y: 450, unlocked: false, completed: false, unlockRequirement: { type: 'net_worth', value: 8000000, label: '₹80,00,000 Net Worth' } },
  { id: 'pakke_bazar', name: 'Pakke Bazar', icon: 'store', emoji: '🛍️', x: 390, y: 630, unlocked: false, completed: false, unlockRequirement: { type: 'player_level', value: 10, label: 'Player Level 10' } },
  { id: 'company_bagh', name: 'Company Bagh', icon: 'trees', emoji: '🌳', x: 390, y: 810, unlocked: false, completed: false, unlockRequirement: { type: 'district_completed', districtId: 'katra', label: 'Complete Katra' } },
  { id: 'court_area', name: 'Court Area', icon: 'landmark', emoji: '⚖️', x: 200, y: 990, unlocked: false, completed: false, unlockRequirement: { type: 'net_worth', value: 3000000, label: '₹30,00,000 Net Worth' } },
  { id: 'katra', name: 'Katra', icon: 'shopping-bag', emoji: '🏘️', x: 390, y: 990, unlocked: false, completed: false, unlockRequirement: { type: 'net_worth', value: 500000, label: '₹5,00,000 Net Worth' } },
  { id: 'badeban', name: 'Badeban', icon: 'flag', emoji: '🏁', x: 580, y: 990, unlocked: true, completed: false, unlockRequirement: { type: 'always', label: 'Starting district' } },
  { id: 'toll_plaza', name: 'Toll Plaza', icon: 'toll-booth', emoji: '🛣️', x: 390, y: 1170, unlocked: false, completed: false, unlockRequirement: { type: 'net_worth', value: 1000000, label: '₹10,00,000 Net Worth' } },
];
...
const roads: Road[] = [
  ...
  { id: 'road_badeban_tollplaza', from: 'badeban', to: 'toll_plaza' },
];
