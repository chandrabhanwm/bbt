...
const districts: District[] = [
  { id: 'railway_station', name: 'Railway Station', icon: 'train', emoji: '🚂', x: 60, y: 60, unlocked: false, completed: false, description: 'A busy platform where every train brings new customers through the city.', unlockRequirement: { type: 'district_completed', districtId: 'purani_basti', label: 'Complete Purani Basti' } },
  ...
  { id: 'bus_stand', name: 'Bus Stand', icon: 'bus', emoji: '🚌', x: 210, y: 360, unlocked: false, completed: false, description: 'The city\'s transit hub — dhabas, taxis, and travelers passing through all day.', unlockRequirement: { type: 'district_completed', districtId: 'pakke_bazar', label: 'Complete Pakke Bazar' } },
  { id: 'pakke_bazar', name: 'Pakke Bazar', icon: 'store', emoji: '🛍️', x: 210, y: 510, unlocked: false, completed: false, description: 'The paved retail strip — fashion, electronics, and the city\'s biggest mall.', unlockRequirement: { type: 'district_completed', districtId: 'company_bagh', label: 'Complete Company Bagh' } },
  ...
  { id: 'court_area', name: 'Court Area', icon: 'landmark', emoji: '⚖️', x: 60, y: 810, unlocked: false, completed: false, description: 'Where the city\'s legal business gets done, one photocopy at a time.', unlockRequirement: { type: 'district_completed', districtId: 'katra', label: 'Complete Katra' } },
