...
const districts: District[] = [
  { id: 'railway_station', name: 'Railway Station', icon: 'train', emoji: '🚂', x: 60, y: 60, unlocked: false, completed: false, description: 'A busy platform where every train brings new customers through Basti.', unlockRequirement: { type: 'net_worth', value: 25000000, label: '₹2,50,00,000 Net Worth' } },
  { id: 'plastic_complex', name: 'Plastic Complex', icon: 'factory', emoji: '🏭', x: 360, y: 60, unlocked: false, completed: false, description: 'The industrial belt powering packaging and manufacturing for the whole city.', unlockRequirement: { type: 'net_worth', value: 30000000, label: '₹3,00,00,000 Net Worth' } },
  { id: 'purani_basti', name: 'Purani Basti', icon: 'building', emoji: '🚧', x: 60, y: 210, unlocked: false, completed: false, description: 'The old market — heritage crafts and recipes passed down for generations.', unlockRequirement: { type: 'district_completed', districtId: 'bus_stand', label: 'Complete Bus Stand' } },
  { id: 'district_hospital', name: 'District Hospital', icon: 'hospital', emoji: '🏥', x: 330, y: 210, unlocked: false, completed: false, description: 'The city\'s medical hub, from the corner pharmacy to the super-specialty wing.', unlockRequirement: { type: 'net_worth', value: 15000000, label: '₹1,50,00,000 Net Worth' } },
  { id: 'bus_stand', name: 'Bus Stand', icon: 'bus', emoji: '🚌', x: 210, y: 360, unlocked: false, completed: false, description: 'Basti\'s transit hub — dhabas, taxis, and travelers passing through all day.', unlockRequirement: { type: 'net_worth', value: 8000000, label: '₹80,00,000 Net Worth' } },
  { id: 'pakke_bazar', name: 'Pakke Bazar', icon: 'store', emoji: '🛍️', x: 210, y: 510, unlocked: false, completed: false, description: 'The paved retail strip — fashion, electronics, and Basti\'s biggest mall.', unlockRequirement: { type: 'player_level', value: 10, label: 'Player Level 10' } },
  { id: 'company_bagh', name: 'Company Bagh', icon: 'trees', emoji: '🌳', x: 210, y: 660, unlocked: false, completed: false, description: 'A leafy park district built for families, food, and weekend leisure.', unlockRequirement: { type: 'district_completed', districtId: 'katra', label: 'Complete Katra' } },
  { id: 'court_area', name: 'Court Area', icon: 'landmark', emoji: '⚖️', x: 60, y: 810, unlocked: false, completed: false, description: 'Where Basti\'s legal business gets done, one photocopy at a time.', unlockRequirement: { type: 'net_worth', value: 3000000, label: '₹30,00,000 Net Worth' } },
  { id: 'katra', name: 'Katra', icon: 'shopping-bag', emoji: '🏘️', x: 210, y: 810, unlocked: false, completed: false, description: 'A wholesale hub — fresh produce, textiles, and the shops that supply the rest of the city.', unlockRequirement: { type: 'net_worth', value: 500000, label: '₹5,00,000 Net Worth' } },
