...
export const districtEconomies: DistrictEconomy[] = [
  {
    ...
    properties: [
      { id: 'tea_stall', name: 'Sunrise Chai Corner', emoji: '☕', baseCost: 12500, baseProfitPerMin: 278, description: 'Hot kadak chai for the whole market.' },
      ...
      { id: 'bakery', name: 'Ganesh Bakery & Sweets', emoji: '🍞', baseCost: 100000, baseProfitPerMin: 1111, description: 'Warm bread, buns, and cream biscuits.' },
      ...
      { id: 'restaurant', name: 'Royal Grill', emoji: '🍽', baseCost: 750000, baseProfitPerMin: 3409, description: 'Sit-down meals for the market crowd.' },
  ...
  },
  {
    ...
    properties: [
      ...
      { id: 'garment_store', name: 'Garment Store', emoji: '👕', baseCost: 350000, baseProfitPerMin: 2752, description: 'Bulk clothing for shops across Basti.' },
  ...
  },
  {
    ...
    properties: [
      ...
      { id: 'luxury_mall', name: 'Luxury Mall', emoji: '🏬', baseCost: 50000000, baseProfitPerMin: 134409, description: 'Basti\'s biggest shopping destination.' },
    ],
  },
  {
    ...
    properties: [
      { id: 'bus_cafe', name: 'Platform Snack Corner', emoji: '☕', baseCost: 87500, baseProfitPerMin: 1507, description: 'Tea and snacks between departures.' },
      { id: 'dhaba', name: 'Highway Tiffin House', emoji: '🍛', baseCost: 225000, baseProfitPerMin: 3171, description: 'Hearty meals for travelers on the move.' },
