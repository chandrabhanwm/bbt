...
export const districtEconomies: DistrictEconomy[] = [
  {
    ...
    properties: [
      { id: 'tea_stall', name: 'Lighthouse Chai Corner', emoji: '☕', baseCost: 12500, baseProfitPerMin: 250, description: 'Hot kadak chai for the whole market.' },
      { id: 'kirana_store', name: 'Mehta Kirana Store', emoji: '🛒', baseCost: 25000, baseProfitPerMin: 550, description: 'Daily groceries and household basics.' },
      { id: 'dairy_shop', name: 'Parekh Dairy Shop', emoji: '🥛', baseCost: 50000, baseProfitPerMin: 1125, description: 'Fresh milk, curd, and paneer every morning.' },
      { id: 'bakery', name: 'Harborside Bakery & Sweets', emoji: '🍞', baseCost: 100000, baseProfitPerMin: 2250, description: 'Warm bread, buns, and cream biscuits.' },
      { id: 'bike_repair', name: 'Kapadia Autoparts', emoji: '🔧', baseCost: 200000, baseProfitPerMin: 4500, description: 'Spare parts and accessories for every two-wheeler.' },
      { id: 'medical', name: 'Shah Medical Store', emoji: '💊', baseCost: 375000, baseProfitPerMin: 8750, description: 'Medicines and essentials, open late.' },
      { id: 'restaurant', name: 'Anchor Grill', emoji: '🍽', baseCost: 750000, baseProfitPerMin: 18750, description: 'Sit-down meals for the market crowd.' },
      { id: 'budget_lodge', name: 'Grand Mahal Banquet Hall', emoji: '💒', baseCost: 1500000, baseProfitPerMin: 37500, description: 'A grand venue for weddings and community functions.' },
    ],
  },
  {
    districtId: 'katra',
    ...
    properties: [
      ...
      { id: 'garment_store', name: 'Garment Store', emoji: '👕', baseCost: 350000, baseProfitPerMin: 8000, description: 'Bulk clothing for shops across CoralBay.' },
  ...
  },
  {
    ...
    properties: [
      ...
      { id: 'luxury_mall', name: 'Luxury Mall', emoji: '🏬', baseCost: 50000000, baseProfitPerMin: 1000000, description: 'CoralBay\'s biggest shopping destination.' },
    ],
  },
  {
    ...
    properties: [
      { id: 'bus_cafe', name: 'Coastal Snack Corner', emoji: '☕', baseCost: 87500, baseProfitPerMin: 1750, description: 'Tea and snacks between departures.' },
      { id: 'dhaba', name: 'Seaside Tiffin House', emoji: '🍛', baseCost: 225000, baseProfitPerMin: 4500, description: 'Hearty meals for travelers on the move.' },
      ...
      { id: 'taxi_stand', name: 'Taxi Stand', emoji: '🚖', baseCost: 1500000, baseProfitPerMin: 30000, description: 'Rides to anywhere in CoralBay.' },
  ...
  },
  {
    ...
    properties: [
      ...
      { id: 'packaging_factory', name: 'Packaging Factory', emoji: '📦', baseCost: 750000, baseProfitPerMin: 15000, description: 'Boxes and wrap for every shop in CoralBay.' },
      ...
      { id: 'mega_industrial_estate', name: 'Mega Industrial Estate', emoji: '🌐', baseCost: 200000000, baseProfitPerMin: 4000000, description: 'CoralBay\'s largest industrial footprint.' },
    ],
  },
  {
  ...
  },
  {
    ...
    properties: [
      ...
      { id: 'legal_business_tower', name: 'Legal Business Tower', emoji: '🏢', baseCost: 11250000, baseProfitPerMin: 225000, description: 'CoralBay\'s tallest address for law firms.' },
    ],
  },
  {
    ...
    properties: [
      ...
      { id: 'antique_store', name: 'Antique Store', emoji: '🏺', baseCost: 5000000, baseProfitPerMin: 100000, description: 'Old CoralBay\'s treasures, carefully kept.' },
