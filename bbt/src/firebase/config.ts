...
const firebaseConfig = {
  apiKey: "AIzaSyB-j-Z4s2rPvjvfeiNwRPCrJZ9YhyqMiCs",
  authDomain: "coralbay-9b791.firebaseapp.com",
  projectId: "coralbay-9b791",
  storageBucket: "coralbay-9b791.firebasestorage.app",
  messagingSenderId: "66637770277",
  appId: "1:66637770277:web:8d92b739873ff85ce4d9cc"
};
...
// (Analytics tab), no custom dashboard needed. Initialized lazily and
// defensively: isSupported() genuinely returns false in some
// environments (certain browsers, private/incognito modes), and
// calling getAnalytics() there would throw. Requires the "Link" step
...
isSupported().then((supported) => {
  if (supported) analyticsInstance = getAnalytics(firebaseApp);
});

/** Logs a custom event to Firebase Analytics — currently used for
 *  ad-watch tracking, the one metric Analytics doesn't capture
 *  automatically. Safe to call even before analyticsInstance is ready
 *  or supported; it's just a no-op in that case rather than a crash. */
