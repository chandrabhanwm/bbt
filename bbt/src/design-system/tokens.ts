...
export const colorTokens = {
  // Background layers — deep charcoal, cool neutral (per the precise
  // Header spec). Each step is a little lighter, used for depth/elevation
  // rather than borders alone.
  background: {
    base: '#111315', // page background, deepest layer
    surface: '#181B1F', // base card surface
    elevated: '#20242A', // floating card / raised panel / secondary surface
    overlay: '#20242A', // dialog / modal surface
  },

  border: {
    subtle: '#23272D', // hairline dividers, barely-there
    default: '#2C3138', // default card border
    strong: '#383F48', // emphasized / active / selected border
  },

  // Gold is the ONE accent color and is used sparingly, per rule 12 —
  // for emphasis (active states, premium badges, primary CTAs), not as
  // a background wash.
  gold: {
    100: '#E9D28A', // lightest — text/icon highlight on dark surfaces
    400: '#D4AF37', // primary gold
    600: '#A8842A', // deep gold — pressed state, gradients, shadows
  ...
  text: {
    primary: '#F5F7FA', // near-white, cool and crisp
    secondary: '#9EA6B2', // muted cool gray
    disabled: '#5B626C',
    inverse: '#111315', // for text set on gold/light surfaces
  },
